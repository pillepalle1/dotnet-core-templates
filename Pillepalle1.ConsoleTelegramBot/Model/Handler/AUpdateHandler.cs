...
{
    public abstract class AUpdateHandler<T>
        where T : UpdateHandlerArgs
    {

        public AUpdateHandler(AUpdateHandler<T> next = null)
        {
            _nextHandler = next;
        }
        ...
        /// </summary>
        public AUpdateHandler<T> NextHandler
        {
            get
            {
                return _nextHandler;
