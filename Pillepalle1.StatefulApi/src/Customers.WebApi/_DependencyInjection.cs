...
public static class _DependencyInjection
{
    ...
    private static WebApplicationBuilder ConfigurePolicies(this WebApplicationBuilder builder)
    {
        builder.Services.AddAuthorizationBuilder()
            .AddPolicy("can-view-customers", policy => policy.RequireClaim("can-view-customers"))
            .AddPolicy("can-modify-customers", policy => policy.RequireClaim("can-modify-customers"));
